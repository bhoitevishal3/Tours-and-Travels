...
<title>Transfers - 404 error</title>
		...
		<div class="wrap">
			<div class="row">
				...
				<div class="content one-half right textongreyRight">
					...
					<p>If you believe that this is an error, please kindly <a href="contact.html">contact us</a> or head straight to our <a href="index-2.html">homepage</a>. Thank you!</p>
				</div>
				<!--- //Content -->
			</div>
		</div>
